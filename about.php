...
<head>
    ...
    <title>WORLDSFRIENDS-ABOUT</title>
...
<body class="bg-light">
  ...
  <div class="my-5 px-4">
    ...
    <p class="text-center mt-3">Lorem ipsum dolor sit, amet consectetur
       adipisicing elit. Perspiciatis, veniam quam. 
       Nulla magni sit architecto voluptas, officiis voluptates
        praesentium libero.<br>
        Nulla magni sit architecto voluptas, officiis voluptates
        praesentium libero.
    </p>
  ...
  <div class="container">
    <div class="row justify-content-between align-items-center">
      ...
      <div class="col-lg-6 col-md-5 mb-4 order-lg-1 order-md-1  order-2">
        ...
        <p>
          Lorem ipsum dolor 
          sit amet consectetur adipisicing elit. Suscipit quaerat et reiciendis, delectus quis accusamus dicta maiores tempora doloribus expedita!
        </p>
      </div>
