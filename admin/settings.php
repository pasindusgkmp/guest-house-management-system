...
<script>
    ...
    function upd_general(site_title_val,site_about_val)
    {
        ...
        {  
            ...
            var modal = bootstrap.Modal.getInstance(myModal); // Ensure "bootstrap" and "modal" are correct
            modal.hide();

            if (this.responseText.trim() === '1') {
            alertMessage('success', 'Changes saved!');
            get_general();
            } else {
                alertMessage('error', 'No changes made!');
            }
    ...
    function upd_shutdown(val)
    {
        ...
        if (this.responseText.trim() == 1 && general_data.shutdown ==0) {
            alertMessage('success', 'Site has been shutdown!');
            
            } else {
                alertMessage('success', 'Shutdown mode off!');
            }
            get_general();
